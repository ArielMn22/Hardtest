...
pulalinha(){ echo ; }
		...
		BANKS=$(dmidecode -t memory | grep "Bank" | cut -d ":" -f2)
			BANK0=1 ; [[ -z $BANK0 ]] && BANK0="(Not Found)"
			BANK1=2 ; [[ -z $BANK1 ]] && BANK1="(Not Found)"
			BANK2=3 ; [[ -z $BANK2 ]] && BANK2="(Not Found)"
			BANK3=4 ; [[ -z $BANK3 ]] && BANK3="(Not Found)"
			BANK4=5 ; [[ -z $BANK4 ]] && BANK4="(Not Found)"
			BANK5=6 ; [[ -z $BANK5 ]] && BANK5="(Not Found)"
			BANK6=7 ; [[ -z $BANK6 ]] && BANK6="(Not Found)"
			BANK7=8 ; [[ -z $BANK7 ]] && BANK7="(Not Found)"
